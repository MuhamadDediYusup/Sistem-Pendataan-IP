                ...
                <form action="{{ url('/rekap/update') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="detail_ruangan" id="" cols="30" rows="2"
                            ...
                            required disabled>{{ $data->detail_ruangan }}</textarea>
                    </div>
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <div class="justify-content-center">
                                    <div class="row">
                                        <div class="col-12">
                                            <img class="img-fluid" src="{{ asset('images/'.$data->img_dxdiag) }}"
                                                alt="Screenshot Dxdiag" style="max-width: 380px>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="justify-content-center">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <img class="img-fluid"
                                                                src="{{ asset('images/'.$data->img_ip) }}"
                                                                alt="Screenshot TCP/IP" style="max-width: 380px">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="justify-content-center">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <img class="img-fluid"
                                                                src="{{ asset('images/'.$data->img_dskmgmn) }}"
                                                                alt="Screenshot Disk Management" style="max-width: 380px>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class=" d-grid gap-2 col-12 pt-3">
                                                            <a href="{{ route('rekap') }}"
                                                                class="btn btn-primary d-grid gap-2 d-md-block">Kembali
                                                                Ke Rekap Data</a>
                                                        </div>
                </form>
            </div>
